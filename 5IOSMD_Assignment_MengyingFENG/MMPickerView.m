...
//  UIColor *buttonTextColor = [[UIColor alloc] initWithCGColor:[options[MMbuttonColor] CGColor]];
    UIColor *buttonTextColor = [[UIColor alloc]initWithCGColor:[UIColor colorWithRed:238.0/255.0 green:97.0/255.0 blue:100.0/255.0 alpha:1.0].CGColor];
...
//    _pickerViewFont = [UIFont systemFontOfSize:22];
      _pickerViewFont = [UIFont fontWithName:@"Roboto-Light" size:22];
  }
...
//  _pickerTopBarView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, _pickerContainerView.frame.size.width, 44.0)];
    _pickerTopBarView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIScreen mainScreen].bounds.size.width, 44.0)];
  ...
  */
  ...
  //Add pickerView
    // TODO: change width
  _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0.0, 44.0, 460, 216.0)];
